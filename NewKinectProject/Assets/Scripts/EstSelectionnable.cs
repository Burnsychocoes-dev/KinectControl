...
public class EstSelectionnable : MonoBehaviour
{
    ...
    [Tooltip("Méthode servant au contrôle d'application pour passer à l'état SELECTIONNE")]
    ...
    void Update()
    {
        ...
        { // On passe de l'état SELECTIONNABLE à l'état SELECTIONNE
            ...
            this.transform.parent = Attach.transform; // Attach devient le père de la cible
        }
