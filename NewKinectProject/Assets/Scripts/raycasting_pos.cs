/* 
Implémentation du RayCasting utisisant les positions relative de la main et de l'épaule pour en déduire la direction du rayon. Le script doit être appliqué au GameObject portant le rayon graphique
...
public class raycasting_pos : MonoBehaviour {
	...
	void Update () {
		if ( kpc_hand.isTracked && kpc_shoulder.isTracked)
        {
            ...
            if (flip_z)
                rv_ray_direction.z = -rv_ray_direction.z;
